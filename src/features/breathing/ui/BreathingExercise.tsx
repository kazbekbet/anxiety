...
export function BreathingExercise({
  ...
  // Handle completion via finished flag
  useEffect(() => {
    if (finished) {
      onComplete(elapsed);
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center justify-center py-4">
        <div className="relative flex h-48 w-48 items-center justify-center">
          <div
            className="absolute inset-0 rounded-full bg-indigo-400/20 dark:bg-indigo-500/20"
            style={{
          ...
          />
          <div
            className="absolute rounded-full bg-indigo-400/40 dark:bg-indigo-500/30"
            style={{
              width: '70%',
              height: '70%',
              transform: `scale(${running ? circleScale : 0.5})`,
