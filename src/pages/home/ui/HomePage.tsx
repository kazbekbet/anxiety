    ...
    <div className="space-y-4">
      ...
      <Card className="text-center">
        {latestEntry ? (
          <div className="flex flex-col items-center gap-3">
            <p className="text-sm text-slate-500 dark:text-slate-400">Последняя запись</p>
          ...
          <div className="py-4">
            <p className="text-slate-500 dark:text-slate-400">Пока нет записей</p>
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-50">Быстрые техники</h2>
          <button
          ...
          {quickTechniques.map((t) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-slate-900 dark:text-slate-50 text-sm">{t.title}</p>
